...
<html lang="en">
    <head>
        <?php
            define('BASE_URL','https://meonery-portfolio.herokuapp.com/portfolio/book-angel/');
        ...
        <link href="<?php echo BASE_URL; ?>assets/css/flickity.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
         <link href="<?php echo BASE_URL; ?>assets/css/jquery.steps.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
        <link href="<?php echo BASE_URL; ?>assets/css/theme-yeller.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
        <link href="<?php echo BASE_URL; ?>assets/css/padding.min.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
        <link href="<?php echo BASE_URL; ?>assets/css/margin.min.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
         <link href="<?php echo BASE_URL; ?>assets/css/hover.min.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
        ...
        <?php } ?>
        <?php if ($page == 'Donate') { ?>
            <link href="<?php echo BASE_URL; ?>assets/css/donate.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
        <?php } ?>
        <?php if ($page == 'Books') { ?>
            <link href="<?php echo BASE_URL; ?>assets/css/books.css" rel="stylesheet" type="text/css" media="all" crossorigin="anonymous" />
        <?php } ?>
