...
<section class="bg--secondary-2 height-100 hero-banner text-center-xs">
	<div class="container pos-vertical-center">
		<div class="row justify-content-between align-items-center">
			<div class="col-12 col-md-6 col-lg-5 mb-xs-40">
				<h1 class="font-600">3 Easy Steps to Donate a Book</h1>
				<p>Welcome to Book Angel. Where you can donate books and other materials that can help Nigerian Children to enhance their education.</p>
				<a href="#to-steps" class="btn btn--blue rounded inner-link hidden-sm hidden-xs">
					<span class="btn__text type--uppercase">View Process</span>
				</a>
				<a href="#to-steps" class="btn btn--blue rounded inner-link hidden-lg hidden-md visible-sm visible-xs">
					<span class="btn__text type--uppercase">View Process</span>
				</a>
			</div>
			<div class="col-12 col-md-5 col-lg-5 text-right text-center-xs">
				<img src="assets/img/hero-image-1.png" class="img-hero">
			</div>
		</div>
	</div>
</section>
...
<section class="bg--darkviolet imagebg unpad">

	<div class="pos-relative pos-right d-flex img-height-90">
		<svg xmlns="http://www.w3.org/2000/svg" width="1077.29" height="670.485" viewBox="0 0 1077.29 670.485" class="pos-absolute pos-right wave">
		  <path id="Path_922" data-name="Path 922" d="M-5673,855.392s-375.024-2.138-407.028,249.718-327.149,183.967-494.427,268.384-175.835,152.382-175.835,152.382H-5673Z" transform="translate(6750.29 -855.392)" fill="#9781aa"/>
		</svg>
		<img src="assets/img/coin-1.svg" class="coin-purse">
		
		<!-- <svg xmlns="http://www.w3.org/2000/svg" width="975.712" height="668.554" viewBox="0 0 975.712 668.554" class="pos-absolute pos-right wave">
		  <path id="Path_878" data-name="Path 878" d="M671.266-207.49,672,411.688C672,435.436,652.748,424,629,424H-302.263c-13.418,0,65.562-84.677,271.59-64.6,231.244-5.009,482.823-572.417,614.116-600.71H604.3s-1.017-.008,51.59,0c7.431-1.359,11.913.174,14.692,3.446C671.588-228.781,671.266-212.113,671.266-207.49Z" transform="translate(303.712 241.801)" fill="#9680a9" opacity="0.708"/>
		</svg> -->
		<div class="w-100 align-self-center p30">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-12 col-md-5">
						<h1 class="font-600 color--orange">No Books but want to donate?</h1>
						<p>You can buy books for Angel Book. Help us end education famine in Nigeria.</p>
						<a href="buy-book" class="btn rounded btn--orange">
							<span class="btn__text type--uppercase">Buy books for Angel Book</span>
						</a>
					</div>
				</div>
			</div>
